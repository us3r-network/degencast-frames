...
import { baseGoerliClient } from "./viem";

const SHARE_ADDRESS = "0xd29648c63fE433aC9306D6473f0F13D4340E1440" as const;
...
export const shareContract = getContract({
  address: shareConfig.address,
  abi: shareConfig.abi,
  client: baseGoerliClient,
});
